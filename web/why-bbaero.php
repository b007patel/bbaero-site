<?php include 'php/html-start-tmpl.php';
	...
	$lhs_html = <<<'EOD'
					<p>How many of us would be nowhere without our parents or our guardians? And how 
					...
					and barring a Polish and an Ohio-based aerospace company, no one else was using 
					"bbaero." So I figured, "Why not?"</p>

					<p>So, Mom, this website (for obvious reasons <i class="fa fa-smile-o"></i>) 
					couldn't be here without you. Thank you so much, even though you always reply, 
					<span id="mom-rant">"I'm your mother!! I DON'T NEED THANK YOU'S!!!!".</span> From the 
					bottom of my heart. <span class="glyphicon glyphicon-heart"></span></p>

					<p>I feel the same way about the rest of my family, even though their nickanmes for 
					me are NFSW. <i class="fa fa-smile-o"></i></p>
