...
EOD;
	...
	$bottom_html = <<<'EOD'
					...
					<div class="grpbox">
						<label><input type="radio" name="suite_type" id="exp_pass" value="exp_pass" onclick="showIDHideOthers(getCurrGBDetailText(), 'div.row div.body-text', '.gb_exp_text')" checked><span>All pass</span></label>
						<label><input type="radio" name="suite_type" value="exp_fail_20" onclick="showIDHideOthers(getCurrGBDetailText(), 'div.row div.body-text', '.gb_exp_text')"><span>20% of tests fail</span></label>
						<label><input type="radio" name="suite_type" value="exp_fail_40" onclick="showIDHideOthers(getCurrGBDetailText(), 'div.row div.body-text', '.gb_exp_text')"><span>40% of tests fail</span></label>
						<label><input type="radio" name="suite_type" value="exp_fail_60" onclick="showIDHideOthers(getCurrGBDetailText(), 'div.row div.body-text', '.gb_exp_text')"><span>60% of tests fail</span></label>
						<label id='cust_pct_label'><input type="radio" name="suite_type" value="exp_fail_cust" onclick="showIDHideOthers(getCurrGBDetailText(), 'div.row div.body-text', '.gb_exp_text')"><span>given % of tests fail</span><input id="cust_pct" name="pct" inputmode='numeric' type="text" minlength=1 maxlength=2 value='10' onblur='document.getElementById("cust_pct_label").click();'>%</label>
					</div>
		...
		<div class="row">
			<div id='testform_rhs_hdr' class='tf_hdr row'>Details</div>
