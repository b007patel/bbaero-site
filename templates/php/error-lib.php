<?php
	// taken from 
	//     http://www.askapache.com/php/php-errordocument.html
	...
	function get_error_vals()
	{
		...
		404 => "We couldn't find <ul><li>%U%</li></ul>on our server, though it's most certainly not your fault.",
		...
		return array( "code"=>$sc, "reason"=>$reason, "message"=>$msg );
	}
	...
	/*function askapache_global_debug()
	{
		...
		array_walk_recursive($g, create_function('$n','global $$n;if( !!$$n&&ob_start()&&(print "[ $"."$n ]n")&&array_walk($$n, create_function('$v,$k', 'echo "[$k] => $vn";'))) echo "<"."p"."r"."e>".htmlspecialchars(ob_get_clean())."<"."/"."pr"."e>";') );
	}*/
?>
